        ...
        [
            html.Div(
                [
                    ...
                    #            ),
                    #    href="https://github.com/paulo-metrostar/NASS-MILK/tree/master/enhance-milk-report-vis/report-generator/dummy-data",
                    #),
                    html.A(
                        "Download full tidy data from this report (xlsx, csv, json, zip)",
                        id="learn-more-button",
                        href = "https://github.com/paulo-metrostar/NASS-MILK/tree/master/report-data-marts/monthly-milk-production/dummy-data",
                ...
                [
                    ...
                    html.Div(
                        [
                            dcc.Link(
                                "Full View",
                                href="/report-generator/full-view",
...
def get_menu():
    menu = html.Div(
        [
            dcc.Link(
                "Overview",
                href="/report-generator/overview",
                className="tab first",
            ),
            dcc.Link(
                "Dictionary & Footnotes",
                href="/report-generator/data_dictionary",
                className="tab",
            ),
            dcc.Link(
                "Tables - Wide",
                href="/report-generator/tables",
                className="tab",
            ),
            dcc.Link(
                "Tidy Data - Long (Mo. Nat. 19-20)",
                href="/report-generator/tidy_data_long_monthly_nat",
                className="tab",
            ),
        ],
